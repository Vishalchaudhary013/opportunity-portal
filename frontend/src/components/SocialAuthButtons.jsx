...
const socialAuthURL = {
  ...
  instagram: `${API_BASE_URL}/api/auth/instagram`,
};
...
const socialProviders = [
  { id: 'google',    label: 'Google',   Icon: GoogleIcon,   textColor: 'text-white' },
  { id: 'linkedin',  label: 'LinkedIn', Icon: LinkedInIcon,  textColor: 'text-white' },
  { id: 'facebook',  label: 'Facebook', Icon: FacebookIcon,  textColor: 'text-white' },
  { id: 'instagram', label: 'Instagram',Icon: InstagramIcon, textColor: 'text-white' },
];

const SocialAuthButtons = ({ mode = 'signup' }) => {
  const handleSocialAuth = (provider) => {
    // Redirect to backend OAuth route
    const redirectURL = socialAuthURL[provider];
