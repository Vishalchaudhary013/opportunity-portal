...
import CollegeGallery from './gallery/CollegeGallery';
const items = [
    { type: 'image', src: "https://picsum.photos/id/1011/600/900" },
    { type: 'video', src: "https://www.w3schools.com/html/mov_bbb.mp4", aspect: "2/3" }, 
    ...
    { type: 'video', src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",aspect: "2/3" },
    { type: 'image', src: "https://picsum.photos/id/1025/600/880" },
    // { type: 'image', src: "https://picsum.photos/id/1052/600/770" },
];
    ...
    return (
        ...
        <CollegeGallery />
            {/* <div className='w-[1300px] mx-auto py-10 mt-10'>
                <SectionTitle title={"Gallery"} subtitle={"Explore highlights, memorable moments, and achievements captured through our journey."} hideViewAll={true} />
