    ...
    <div>
      <div className="">
                <div className="w-full max-w-[1350px] px-4 md:px-6 mx-auto py-10">
                   <div className="mb-5">
            <SectionTitle title="Most In-Demand Skill Certificate Programs" subtitle="Validate Your Expertise with Top-Tier Industry Credentials" defination={"Targeted certifications mapped directly to current global hiring trends. These programs focus entirely on building and certifying proficiency in elite enterprise tools and modern frameworks."} viewAllLink="/certificate-programs"/>
          </div>
